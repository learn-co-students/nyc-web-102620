...
#### Authorization
- can't create a planet unless logged in
- Can't delete a planet unless logged in
- Create a Trip without having to select yourself
- Can only see the logged_in aliensc show page
